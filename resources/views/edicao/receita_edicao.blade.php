            ...
            <div class='form-row'>
                <div class="col-md-5">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input style="width:160%" name="nome_fabrica" value="{{$data['nome_fabrica']}}"type="text" class="form-control" id="buscaMedicamento" placeholder="Pesquise o medicamento">
                ...
                <input name='qtd' value="{{$data['qtd']}}" type="number" class="form-control" id="idNum" placeholder="Quantidade">
                </div>
                <div class="form-group col-md-2" id="unidade">
                    <input name='unidade' value="{{$data['unidade']}}" type="" class="form-control" id="idNum" placeholder="Unidade">
                </div>
                <div class="form-group col-md-2" id="via">
                <input name='via' type="" value = {{$data['via']}} class="form-control" id="idNum" placeholder="Via">
                </div>
            </div>
            <div class='form-row'>
                <div class="form-group col-md-11" id="procedimento">
                    <label for="idObservacao">Procedimento</label>
                    <textarea name="procedimento"  rows="5" type="textArea" class="form-control" id="idObservacao" placeholder="">{{$data['procedimento']}}</textarea>
                </div>
            </div>
            <button type="submit" id="salvarReceita"class="btn btn-primary">Atualizar</button>
        </form>
    </div>
